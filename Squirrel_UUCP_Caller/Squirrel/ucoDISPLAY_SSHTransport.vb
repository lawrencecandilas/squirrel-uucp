Public Class ucoDISPLAY_SSHTransport
    Public Sub SetFields(in_params As Hashtable)
        DebugOut("ucoDISPLAY_SSHTransport.SetFields(in_params)")
    ...
    Private Sub ucoDISPLAY_SSHTransport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dock = DockStyle.Fill
    End Sub
